 ...
 * <ul>
 * <li>For ALL installments (in installment order): Principal, then Interest</li>
 ...
 * </ul>
 */
public class OverdueDueAdvPrincipalInterestOverdueDuePenaltiesFeesOrderLoanRepaymentScheduleTransactionProcessor
        extends AbstractLoanRepaymentScheduleTransactionProcessor {

    public static final String STRATEGY_CODE = "overdue-due-adv-principal-interest-overdue-due-penalties-fees-order-strategy";

    public static final String STRATEGY_NAME = "Overdue/Due Adv Principal/Interest, Overdue/Due Penalties/Fees Order";

    public OverdueDueAdvPrincipalInterestOverdueDuePenaltiesFeesOrderLoanRepaymentScheduleTransactionProcessor(
    ...
    private Money handleTransactionThatIsNormalRepaymentAcrossAllInstallmentsThenOverduePenaltiesFees(
        ...
        // First pass: pay Principal then Interest for ALL installments.
