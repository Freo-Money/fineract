 ...
 * installment: Interest, then Principal. Then for each overdue/due installment: Fees, then Penalties.
 *
 * Example: With 3 overdue installments and 1 due installment: Payment order: Interest1, Principal1, Interest2,
 * Principal2, Interest3, Principal3, Interest4, Principal4, then Fees1, Penalties1, Fees2, Penalties2, Fees3,
 * Penalties3, Fees4, Penalties4.
 */
public class OverdueDueInterestPrincipalOverdueDueFeesPenaltiesOrderLoanRepaymentScheduleTransactionProcessor
        extends AbstractLoanRepaymentScheduleTransactionProcessor {

    public static final String STRATEGY_CODE = "overdue-due-interest-principal-overdue-due-fees-penalties-order-strategy";

    public static final String STRATEGY_NAME = "Overdue/Int/Principal,Fees";

    public OverdueDueInterestPrincipalOverdueDueFeesPenaltiesOrderLoanRepaymentScheduleTransactionProcessor(
    ...
    /**
     * For late repayments, pays Interest+Principal for each overdue/due installment in order, then Fees+Penalties for
    ...
    /**
     * For normal on-time repayments, pays Interest first, then Principal, then Fees, then Penalties.
     */
    @Override
    ...
    protected Money handleRefundTransactionPaymentOfInstallment(final LoanRepaymentScheduleInstallment currentInstallment,
        ...
        // Reverse order: Penalties, Fees, Principal, Interest
