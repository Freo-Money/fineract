...
public class AllPrincipalAllInterestThenPenaltiesFeesOrderLoanRepaymentScheduleTransactionProcessor
    ...
    public static final String STRATEGY_CODE = "all-principal-all-interest-then-penalties-fees-order-strategy";

    public static final String STRATEGY_NAME = "All Principal, All Interest, then All Penalties, then All Fees";

    public AllPrincipalAllInterestThenPenaltiesFeesOrderLoanRepaymentScheduleTransactionProcessor(final ExternalIdFactory externalIdFactory,
