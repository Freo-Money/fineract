...
public class LoanProduct extends AbstractPersistableCustom<Long> {
    ...
    public LoanProduct(final Fund fund, final String transactionProcessingStrategyCode,
            ...
            final boolean enableDownPayment, final boolean enableScheduleArchive, final boolean enableExcessPaymentParking,
            final BigDecimal disbursedAmountPercentageForDownPayment, final boolean enableAutoRepaymentForDownPayment,
            final RepaymentStartDateType repaymentStartDateType, final boolean enableInstallmentLevelDelinquency,
            final LoanScheduleType loanScheduleType, final LoanScheduleProcessingType loanScheduleProcessingType, final Integer fixedLength,
        ...
        this.loanProductRelatedDetail = new LoanProductRelatedDetail(currency, defaultPrincipal, defaultNominalInterestRatePerPeriod,
                ...
                isInterestRecalculationEnabled, isEqualAmortization, enableDownPayment, enableScheduleArchive, enableExcessPaymentParking,
                ...
                isInterestRecognitionOnDisbursementDate, daysInYearCustomStrategy, enableIncomeCapitalization,
