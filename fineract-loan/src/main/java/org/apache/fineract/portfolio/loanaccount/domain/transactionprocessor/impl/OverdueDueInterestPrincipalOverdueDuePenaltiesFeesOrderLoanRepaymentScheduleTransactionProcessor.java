 ...
 * installment: Interest, then Principal. Then for each overdue/due installment: Penalties, then Fees.
 *
 * Example: With 3 overdue installments and 1 due installment: Payment order: Interest1, Principal1, Interest2,
 * Principal2, Interest3, Principal3, Interest4, Principal4, then Penalties1, Fees1, Penalties2, Fees2, Penalties3,
 * Fees3, Penalties4, Fees4.
 */
public class OverdueDueInterestPrincipalOverdueDuePenaltiesFeesOrderLoanRepaymentScheduleTransactionProcessor
        extends AbstractLoanRepaymentScheduleTransactionProcessor {

    public static final String STRATEGY_CODE = "overdue-due-interest-principal-overdue-due-penalties-fees-order-strategy";

    public static final String STRATEGY_NAME = "Overdue/Due Interest/Principal, Overdue/Due Penalties/Fees Order";

    public OverdueDueInterestPrincipalOverdueDuePenaltiesFeesOrderLoanRepaymentScheduleTransactionProcessor(
    ...
    /**
     * For late repayments, pays Interest+Principal for each overdue/due installment in order, then Penalties+Fees for
    ...
    protected Money handleTransactionThatIsALateRepaymentOfInstallment(final LoanRepaymentScheduleInstallment currentInstallment,
        ...
        if (loanTransaction.isChargesWaiver()) {
            ...
            // First pass: Pay Interest+Principal for each overdue/due installment
            ...
            // Second pass: Pay Penalties+Fees for each overdue/due installment
            for (final LoanRepaymentScheduleInstallment installment : installments) {
    ...
    /**
     * For normal on-time repayments, pays Interest first, then Principal, then Penalties, then Fees.
     */
    @Override
