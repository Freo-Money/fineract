 ...
 * installment: Principal, then Interest. Then for each overdue/due installment: Penalties, then Fees.
 *
 * Example: With 3 overdue installments and 1 due installment: Payment order: Principal1, Interest1, Principal2,
 * Interest2, Principal3, Interest3, Principal4, Interest4, then Penalties1, Fees1, Penalties2, Fees2, Penalties3,
 * Fees3, Penalties4, Fees4.
 */
public class OverdueDuePrincipalInterestOverdueDuePenaltiesFeesOrderLoanRepaymentScheduleTransactionProcessor
        extends AbstractLoanRepaymentScheduleTransactionProcessor {

    public static final String STRATEGY_CODE = "overdue-due-principal-interest-overdue-due-penalties-fees-order-strategy";

    public static final String STRATEGY_NAME = "Overdue/Due Principal/Interest, Overdue/Due Penalties/Fees Order";

    public OverdueDuePrincipalInterestOverdueDuePenaltiesFeesOrderLoanRepaymentScheduleTransactionProcessor(
    ...
    /**
     * For late repayments, pays Principal+Interest for each overdue/due installment in order, then Penalties+Fees for
    ...
    /**
     * For normal on-time repayments, pays Principal first, then Interest, then Penalties, then Fees.
     */
    @Override
    ...
    protected Money handleRefundTransactionPaymentOfInstallment(final LoanRepaymentScheduleInstallment currentInstallment,
        ...
        // Reverse order: Fees, Penalties, Interest, Principal
