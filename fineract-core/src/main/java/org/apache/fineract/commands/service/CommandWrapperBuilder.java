...
public class CommandWrapperBuilder {
    ...
    public CommandWrapperBuilder loanPartPaymentTransaction(final Long loanId) {
        this.actionName = "PART_PAYMENT";
        this.entityName = "LOAN";
        this.entityId = null;
        this.loanId = loanId;
        this.href = "/loans/" + loanId + "/transactions?command=partPayment";
        return this;
    }
    ...
    public CommandWrapperBuilder recalculateLoanSummary(final Long loanId) {
        this.actionName = "RECALCULATESUMMARY";
        this.entityName = "LOAN";
        this.entityId = loanId;
        this.loanId = loanId;
        this.href = "/loans/" + loanId + "?command=recalculateSummary";
        return this;
    }

    public CommandWrapperBuilder reprocessLoanTransactions(final Long loanId) {
        this.actionName = "REPROCESSTRANSACTIONS";
        this.entityName = "LOAN";
        this.entityId = loanId;
        this.loanId = loanId;
        this.href = "/loans/" + loanId + "?command=reprocessTransactions";
        return this;
    }
