...
public class LoanWritePlatformServiceJpaRepositoryImpl implements LoanWritePlatformService {
    ...
    public CommandProcessingResult forecloseLoan(final Long loanId, final JsonCommand command) {
        ...
        Map<Long, BigDecimal> foreclosureChargePercentageMap = extractChargePercentagesFromJson(element);
    ...
    private Map<Long, BigDecimal> extractChargePercentagesFromJson(JsonElement element) {
        try {
            return foreclosureChargeHelper.extractChargePercentagesFromJsonElement(element,
