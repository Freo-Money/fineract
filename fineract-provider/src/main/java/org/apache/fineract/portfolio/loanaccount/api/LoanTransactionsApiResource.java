...
public class LoanTransactionsApiResource {
    ...
    private String retrieveTransactionTemplate(Long loanId, String loanExternalIdStr, String commandParam, UriInfo uriInfo,
        ...
        if (CommandParameterUtil.is(commandParam, "repayment")) {
            ...
            Map<Long, BigDecimal> chargePercentages = extractChargePercentagesFromQueryParam(uriInfo);
    ...
    private Map<Long, BigDecimal> extractChargePercentagesFromQueryParam(UriInfo uriInfo) {
        ...
        try {
            return foreclosureChargeHelper.extractChargePercentagesFromJsonString(chargePercentagesJson);
