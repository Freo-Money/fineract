...
@CommandType(entity = "LOAN", action = "BULKREPROCESS_RELEASE")
public class LoanBulkReprocessReleasePendingCommandHandler implements NewCommandSourceHandler {

    private final LoanBulkReprocessRunWritePlatformService writePlatformService;

    @Override
    public CommandProcessingResult processCommand(JsonCommand command) {
        return writePlatformService.releasePendingItems(command);
    }
}
