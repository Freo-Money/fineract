...
public class LoanProductAssembler {
    ...
    public LoanProduct assembleFromJson(final Fund fund, final String loanTransactionProcessingStrategy, final List<Charge> productCharges,
        ...
        boolean adjustInterestForRounding = false;
        if (command.parameterExists(LoanProductConstants.ADJUST_INTEREST_FOR_ROUNDING_PARAM_NAME)) {
            adjustInterestForRounding = command
        ...
        return new LoanProduct(fund, loanTransactionProcessingStrategy, loanProductPaymentAllocationRules, loanProductCreditAllocationRules,
                ...
                overAppliedCalculationType, overAppliedNumber, dueDaysForRepaymentEvent, overDueDaysForRepaymentEvent, enableDownPayment, enableScheduleArchive,
